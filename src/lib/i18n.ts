...
export const copy = {
  vi: {
    tiers: ['BÌNH DÂN', 'QUEN THUỘC', 'ĐẶC SẢN', 'THƯỢNG HẠNG', '★ BẾP TRƯỞNG'],
    title: 'Ăn gì cũng được?', counterPrefix: 'Đã quay', counterSuffix: 'lượt',
    counterTitle: 'Số lượt quay chọn món ăn ghi nhận trên trình duyệt này', caseLabel: 'Vòng quay chọn món ăn',
    soundOn: 'Âm thanh bật', soundOff: 'Âm thanh tắt', turnSoundOff: 'Tắt âm thanh', turnSoundOn: 'Bật âm thanh',
    github: 'Mã nguồn', starsPending: 'chưa tải', language: 'Switch to English',
    spend: 'Mức chi mong muốn', custom: 'Tuỳ chỉnh', customSpend: 'Mức chi tuỳ chỉnh (nghìn đồng)',
    thousandPerMeal: 'nghìn / bữa', spendError: 'Nhập từ 30 đến 180 nghìn.', vegetarianPool: 'Thực đơn hiện tại: trung bình',
    vegetarianOnly: 'Chỉ ăn chay', vegetarian: 'Ăn chay', opening: 'ĐANG CHỌN MÓN…', openAgain: 'QUAY LẠI', open: 'QUAY CHỌN MÓN',
    newItem: 'MÓN NGON DÀNH CHO BẠN', referencePrice: 'Giá tham khảo', perPerson: '/ người', find: 'TÌM QUÁN', continue: 'CHỐT MÓN NÀY', nearby: 'gần đây',
    whatsInside: 'THỰC ĐƠN HÔM NAY', items: 'Món ăn trong thực đơn', mystery: '★ MÓN BÍ MẬT BẾP TRƯỞNG', mysteryAlt: 'Món bí mật thượng hạng của bếp trưởng',
    footer: 'Ăn Gì Cũng Được? — Vòng quay giải cứu mỗi bữa ăn', lunchDish: 'Món ăn trưa', vegetarianDish: 'Món chay',
  },
  en: {
    tiers: ['CASUAL', 'POPULAR', 'SPECIALTY', 'PREMIUM', '★ CHEF SPECIAL'],
    title: 'What to eat for lunch?', counterPrefix: 'Spun', counterSuffix: 'times',
    counterTitle: 'Meal spins recorded on this browser', caseLabel: 'Lunch selection roulette',
    soundOn: 'Sound on', soundOff: 'Sound off', turnSoundOff: 'Mute sound', turnSoundOn: 'Enable sound',
    github: 'Source code', starsPending: 'not loaded', language: 'Chuyển sang tiếng Việt',
    spend: 'Target lunch budget', custom: 'Custom', customSpend: 'Custom spend (thousand VND)',
    thousandPerMeal: 'thousand VND / meal', spendError: 'Enter 30–180 thousand VND.', vegetarianPool: 'Current menu average',
    vegetarianOnly: 'Vegetarian only', vegetarian: 'Vegetarian', opening: 'SPINNING DISHES…', openAgain: 'SPIN AGAIN', open: 'SPIN FOR LUNCH',
    newItem: 'YOUR LUNCH TODAY', referencePrice: 'Typical price', perPerson: '/ person', find: 'FIND NEARBY', continue: 'ENJOY THIS DISH', nearby: 'near me',
    whatsInside: "TODAY'S MENU", items: 'Dishes in this menu', mystery: "★ CHEF'S SURPRISE", mysteryAlt: "Chef's surprise gourmet dish",
    footer: 'Lunch Decision Maker — Fun & Random', lunchDish: 'Lunch dish', vegetarianDish: 'Vegetarian',
  },
} as const;
